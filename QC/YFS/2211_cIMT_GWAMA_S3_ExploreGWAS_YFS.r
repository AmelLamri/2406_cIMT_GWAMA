...
m_p <- "/genetics/MixedStudies/Projects/2211_cIMT_GWAMA_PHRI/Results/GWAMA/"
kg_p <- "/home/lamria/avr/Data/1000Genomes/20130502_Release/Genotypes/PLINK/Sample_Subsets/Europeans/SNP_Subsets/mac10/"
pheno <- "maxIMT_YAD" 

d <- read.table(gzfile( "/genetics/MixedStudies/Projects/2211_cIMT_GWAMA_PHRI/Results/GWAS/YFS/Cleaned/YAD_maxLCF/CLEANED.EGG_cIMT.maxLCF.YAD.MW.noBMI.YFS.EUR.LPL.231001.cpaid.gz"), head=T, string=F)
nrow(d)
...
manhattan(d[which(d$CHR %in% 1:22),],p="PVAL", chr="CHR", bp="POS", snp="SNPID" )
dev.off()
